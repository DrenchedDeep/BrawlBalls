...
namespace RotaryHeart.Lib.PhysicsExtension
{
    ...
    public static partial class Physics
    {
        ...
        public static readonly Quaternion M_orientation = default(Quaternion);
        public static readonly float M_maxDistance = Mathf.Infinity;
        public static readonly int M_layerMask = -1;
        public static readonly QueryTriggerInteraction M_queryTriggerInteraction = QueryTriggerInteraction.UseGlobal;
        internal static readonly Color M_castColor = new Color(1, 0.5f, 0, 1);
