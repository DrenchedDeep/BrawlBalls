...
namespace RotaryHeart.Lib.PhysicsExtension
{
    ...
    public static partial class Physics2D
    {
        ...
        public readonly static float M_maxDistance = Mathf.Infinity;
        public readonly static int M_layerMask = -1;
            ...
            PreviewCondition preview = PreviewCondition.None, float drawDuration = 0, Color? hitColor = null, Color? noHitColor = null, bool drawDepth = false, CastDrawType drawType = CastDrawType.Minimal)
        {
            ...
            contactFilter.minDepth = minDepth;
            contactFilter.maxDepth = maxDepth;
            ...
            PreviewCondition preview = PreviewCondition.None, float drawDuration = 0, Color? hitColor = null, Color? noHitColor = null, bool drawDepth = false, CastDrawType drawType = CastDrawType.Minimal)
        {
            ...
            int count = UEPhysics2D.CapsuleCast(origin, size, capsuleDirection, angle, direction, contactFilter, results,
                distance);
